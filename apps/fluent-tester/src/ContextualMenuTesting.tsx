...
const SubmenuTest = () => {
  ...
  const anchorRef = React.useRef<View>(null);
  const submenuItemRef = React.useRef<View>(null);
      ...
      {showMenu && (
        ...
        >
          <ContextualMenuItem
            ...
            itemKey="action1"
          />
          <View ref={submenuItemRef} collapsable={false}>
            <SubmenuItem
              text="More Options"
              itemKey="submenu"
              expanded={showSubmenu}
              onClick={() => {
                console.log('[SubmenuTest] onClick triggered');
            ...
            >
              {showSubmenu && (
                <Submenu
                  target={submenuItemRef as any}
                  onDismiss={() => setShowSubmenu(false)}
