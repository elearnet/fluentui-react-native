...
- (NSString *)getSystemColorCommon:(NSString *)colorName {
#if TARGET_OS_OSX
...
- (NSDictionary<NSString *, NSString *> *)getSystemColorsCommon {
...
{
  return [self getSystemColorCommon:colorName];
}

RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getSystemColors)
{
  return [self getSystemColorsCommon];
}
#endif
