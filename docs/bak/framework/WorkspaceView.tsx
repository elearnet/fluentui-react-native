...
const WorkspaceTab = ({
    ...
    return (
        <Tab
            ...
            onLongPress={() => {
                if (tabRef.current) {
                    onLongPress(index, tabRef);
                }
            }}
            onPressIn={(e: any) => {
                 // Debug: check button state if needed
                 if (e.nativeEvent.button === 2) {
                     // Right click detected via PressIn (optional fallback)
                 }
            }}
      ...
      <View style={[styles.tabListContainer, isLeftCollapsed ? { marginLeft: minSidePaneWidth } : {}]}>
        ...
        {isContextMenuVisible && contextMenuTarget && (
            <Callout
                ...
                style={{
                  backgroundColor: 'white', // Basic white bg
                  borderWidth: 1,
                  borderColor: '#ddd',
                  padding: 4,
                  borderRadius: 4,
            ...
            >
                <TouchableOpacity
                   ...
                   <SysIcon symbolName="xmark" style={{width: 14, height: 14, marginRight: 8}} />
                   <Text>Close Tab</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                   ...
                   <SysIcon symbolName="arrow.left.and.right" style={{width: 14, height: 14, marginRight: 8}} />
                   <Text>Close Others</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                   ...
                   <SysIcon symbolName="arrow.right.to.line" style={{width: 14, height: 14, marginRight: 8}} />
                   <Text>Close to the Right</Text>
                </TouchableOpacity>
            </Callout>
        )}
      </View>
