...
const DefaultTabGroup = ({ split, activeIndex, onSelect }: { split: WorkspaceSplit, activeIndex: number, onSelect: (index: number) => void }) => {
...
const DefaultTabRenderer = (split: WorkspaceSplit, activeIndex: number, onSelect: (index: number) => void) => {
    return <DefaultTabGroup split={split} activeIndex={activeIndex} onSelect={onSelect} />;
};
